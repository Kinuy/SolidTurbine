...
BladeGeometrySection& BladeGeometryData::getRowByRadius(double radius, double tolerance){
...
BladeGeometrySection& BladeGeometryData::getRowByRelativeThickness(double relativeThickness, double tolerance){
    auto it = std::find_if(rows.begin(), rows.end(),
...
BladeGeometrySection& BladeGeometryData::getRowByIndex(int index){
